...
<head>
    ...
    <title>Employee Database - View Users</title>
...
<body>
    ...
    <div class="container">
     ...
     <div class="row">
        ...
        <div class ="col-6"></div> <h3>View Employees</h3>
        <div class="row">
        <div class ="col-6"></div> 
        <a href= "<?php echo base_url().'index.php/user/create';?>" class= "btn btn-primary">Add</a> 
</div>
            <hr>
            <div class="row">
                <div class="col-md-8">
